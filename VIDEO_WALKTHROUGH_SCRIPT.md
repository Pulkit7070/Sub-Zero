...
## 📝 SCENE 2: Personal vs Enterprise Choice (0:30 - 1:15)
...
>
> Second, there's **Enterprise mode** - built for organizations that need centralized control over company-wide SaaS spending. This is what we're seeing incredible ROI with - companies saving 15-30% on their SaaS budget within the first quarter.
>
...
## 📝 SCENE 3: Enterprise Dashboard Overview (1:15 - 3:00)
...
- **Scroll through each quick win:**
  1. "Reduce Slack licenses - 32 users haven't logged in for 60+ days. Save $1,920 per month."
  2. "Cancel unused Figma seats - 12 seats with zero activity in 90 days. Save $1,440 per month."
  3. "Switch Zoom to Business plan - their Enterprise features are barely used. Save $950 per month."
...
>
> This underutilization represents $8,475 in monthly waste, or over $100,000 annually that's essentially being thrown away."

---

## 📝 SCENE 4: Decisions - AI Analysis (3:00 - 4:30)
...
> - Reviews historical usage trends
...
>
> The risk score is only 15% - meaning this is a very safe decision with minimal business impact.
>
> We recommend reducing from 156 to 124 licenses, and we show exactly which users are inactive, when they last logged in, and why this is a safe change."

---

## 📝 SCENE 5: Subscriptions Management (4:30 - 5:45)
...
>
> Each subscription card shows critical information..."
...
> - Red means critical (under 30%)
>
> This gives finance and IT teams instant visibility into subscription health."

---

## 📝 SCENE 6: Tools Discovery (5:45 - 6:45)
...
> - And more...
>
> Each tool has a 'Keystone Score' - this is our measure of how critical it is to the business."
...
>
> Compare that to Figma at 6.5 with only 3 dependencies - important for the design team, but less critical company-wide.
>
> This helps prioritize which tools need careful consideration before making changes."
...
## 📝 SCENE 7: User Management (6:45 - 7:30)
...
> - Prevent continued charges"

---

## 📝 SCENE 8: Settings & Integration (7:30 - 8:15)
...
## 📝 SCENE 9: How It Works - Behind the Scenes (8:15 - 9:15)
...
## 📝 SCENE 10: Value Proposition & ROI (9:15 - 10:00)
...
## 📝 SCENE 11: Call to Action (10:00 - 10:30)
...
>
> Visit sub-zero.io to get started, or contact us for a personalized demo.
>
...
- Include **background music** at 10-15% volume (optional)
...
- [ ] Browser window at consistent size (1920x1080 or 1280x720)
...
4. Add transitions and overlays
5. Review for smooth flow
...
**0:30-1:00** - Dashboard Overview (quick stats)
**1:00-1:30** - Run Analysis Demo + Results
**1:30-2:00** - Subscriptions Overview
**2:00-2:30** - Quick Wins Explanation
**2:30-3:00** - ROI + Call to Action
...
- [ ] Audio normalization (-14 LUFS for web)
- [ ] Remove "ums" and long pauses
- [ ] Add intro animation (5 seconds max)
- [ ] Add outro with CTA (10 seconds)
...
Try Sub-Zero free: [LINK]

Timestamps:
0:00 Introduction
0:30 Personal vs Enterprise
...
- ✅ Subscriptions with 5 detailed examples
